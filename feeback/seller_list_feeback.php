    ...
    <head>
        ...
        <style>
            ...
            .container1 .product-details h1, .container2 .product-details h1{
            ...
            .container1 .product-details>p, .container2 .product-details>p{
            ...
            @media (max-width: 768px) {
                ...
                .container1 .product-details, .container2 .product-details{
                    width: 70%;
                    padding: 10px;
                }
                .container1 .product-image, .container2 .product-image {
                    width: 30%;
                }
                .container1 .product-details h1, .container2 .product-details h1  {
                        font-size: 15px;
    ...
    <body>
    <h1 style="margin:20px;">View Feeback</h1>
    <br/>

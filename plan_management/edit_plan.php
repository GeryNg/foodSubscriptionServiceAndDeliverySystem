...
?>
    ...
    <div class="container" style="margin-top:20px;">
        <section class="col col-lg-7">
            ...
            <?php if ($plan): ?>
                <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <?php if ($documents): ?>
                            <div class="d-flex flex-wrap">
                                ...
                                foreach ($images as $image): ?>
                                    <div class="p-2">
                                        <img src="<?php echo htmlspecialchars($image); ?>" alt="Plan Image" class="document-image" />
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
                    ...
                    <button type="submit" name="updatePlan" class="btn btn-primary pull-right">Update Plan Details</button>
                </form>
            <?php else: ?>
        ...
        <br />
        <br />
        <p><a href="list_plan.php">Back</a></p>
    </div>
